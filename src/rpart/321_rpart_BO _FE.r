...
ksemilla_azar  <- 200891   #cambiar por la primer semilla
...
#cargo el dataset
dataset  <- fread("./labo/exp/FE4020/paquete_premium_202011_ext1.csv")   #donde entreno


#creo la carpeta donde va el experimento
# HT  representa  Hiperparameter Tuning
dir.create( "./labo/exp/",  showWarnings = FALSE ) 
dir.create( "./labo/exp/FE5020/", showWarnings = FALSE )
setwd("C:/Users/Bianca/OneDrive/Documentos/Archivos/ITBA/MineriaDeDatos/labo/exp/FE5020/")   #Establezco el Working Directory DEL EXPERIMENTO


archivo_log  <- "FE502.txt"
archivo_BO   <- "FE502.RDATA"
