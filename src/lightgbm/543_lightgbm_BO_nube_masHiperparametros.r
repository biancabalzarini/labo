#Agrego más hipermarámetros a la optimización bayesiana
...
hs <- makeParamSet( 
         makeNumericParam("learning_rate",    lower=  0.007 , upper=    0.3),
         ...
         makeNumericParam("min_gain_to_split",lower=  0    , upper=   1000)
         )
...
EstimarGanancia_lightgbm  <- function( x )
{
  ...
  param_basicos  <- list( objective= "binary",
                          ...
                          is_unbalance= TRUE       #le digo que las clases están desbalanceadas
                          )
...
dir.create( "./exp/HT5460/", showWarnings = FALSE )
setwd("./exp/HT5460/")   #Establezco el Working Directory DEL EXPERIMENTO


#en estos archivos quedan los resultados
kbayesiana  <- "HT546.RDATA"
klog        <- "HT546.txt"
