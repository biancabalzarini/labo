...
kdataset_salida  <- "paquete_premium_ext_001.csv.gz" #CAMBIAR NOMBRE CADA VEZ QUE GENERO UN DATASET NUEVO !!
...
AgregarVariables  <- function( dataset )
{
  ...
  #NO ENTIENDO :( ACA TENGO QUE AGREGAR LOS LAGS, TENDENCIAS Y ESAS COSAS? NO, NO? CREO QUE ESO SE HACE DE OTRA FORMA
