...
EnriquecerDataset  <- function( dataset , arch_destino )
{
  ...
  #Ahora invento yo variables nuevas :)
...
setwd("C:/Users/Bianca/OneDrive/Documentos/Archivos/ITBA/MineriaDeDatos/labo/exp/FE4020/")   #Establezco el Working Directory DEL EXPERIMENTO

#Le voy a agregar un 1, 2, 3, ... al final del nombre por si voy haciendo mas versiones de datasets con nuevos features
EnriquecerDataset( dataset1, "paquete_premium_202011_ext1.csv" )
EnriquecerDataset( dataset2, "paquete_premium_202101_ext1.csv" )
